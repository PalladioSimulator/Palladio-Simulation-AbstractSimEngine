...
public class BusProcess extends AbstractSimProcessDelegator {
    ...
    private void loadPassengers() throws SuspendExecution {
    ...
    private void travelToNextStation() throws SuspendExecution {
    ...
    private void unloadPassengers() throws SuspendExecution {
        BusStop position = bus.getPosition();
