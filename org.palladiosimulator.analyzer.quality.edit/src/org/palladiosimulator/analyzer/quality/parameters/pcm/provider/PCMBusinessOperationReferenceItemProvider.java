...
public class PCMBusinessOperationReferenceItemProvider extends OperationReferenceItemProvider {
    ...
    protected void addRolePropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PCMBusinessOperationReference_role_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_PCMBusinessOperationReference_role_feature",
    ...
    protected void addSignaturePropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_PCMBusinessOperationReference_signature_feature"),
                this.getString("_UI_PropertyDescriptor_description",
                        "_UI_PCMBusinessOperationReference_signature_feature",
                        "_UI_PCMBusinessOperationReference_type"),
    ...
    public Object getImage(final Object object) {
        return this.overlayImage(object,
                this.getResourceLocator().getImage("full/obj16/PCMBusinessOperationReference"));
    }
    ...
    public String getText(final Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_PCMBusinessOperationReference_type")
                : this.getString("_UI_PCMBusinessOperationReference_type") + " " + label;
    }
