...
public class PCMOperationParameterReferenceItemProvider extends PCMParameterReferenceItemProvider {
    ...
    protected void addParameterPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PCMOperationParameterReference_parameter_feature"),
                this.getString("_UI_PropertyDescriptor_description",
                        "_UI_PCMOperationParameterReference_parameter_feature",
    ...
    public Object getImage(final Object object) {
        return this.overlayImage(object,
                this.getResourceLocator().getImage("full/obj16/PCMOperationParameterReference"));
    }
    ...
    public String getText(final Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_PCMOperationParameterReference_type")
                : this.getString("_UI_PCMOperationParameterReference_type") + " " + label;
    }
