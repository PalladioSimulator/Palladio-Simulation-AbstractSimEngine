...
import org.palladiosimulator.analyzer.quality.parameters.provider.ParameterReferenceItemProvider;
import org.palladiosimulator.analyzer.quality.provider.QualityEditPlugin;

/**
 * This is the item provider adapter for a
 * {@link org.palladiosimulator.analyzer.quality.parameters.pcm.PCMParameterReference} object. <!--
...
public class PCMParameterReferenceItemProvider extends ParameterReferenceItemProvider {
    ...
    public String getText(final Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_PCMParameterReference_type")
                : this.getString("_UI_PCMParameterReference_type") + " " + label;
    }
