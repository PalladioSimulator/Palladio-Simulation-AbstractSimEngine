 ...
 * {@link org.palladiosimulator.analyzer.quality.qualityannotation.RequiredElement} object. <!--
...
public class RequiredElementItemProvider extends IdentifierItemProvider {
    ...
    public String getText(final Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_RequiredElement_type")
                : this.getString("_UI_RequiredElement_type") + " " + label;
    }
    ...
    protected void collectNewChildDescriptors(final Collection<Object> newChildDescriptors, final Object object) {
        ...
        newChildDescriptors.add(this.createChildParameter(QualityAnnotationPackage.Literals.REQUIRED_ELEMENT__CHILD_RES,
        ...
        newChildDescriptors.add(this.createChildParameter(QualityAnnotationPackage.Literals.REQUIRED_ELEMENT__PRECISION,
