...
public class DesmoJExperiment extends AbstractExperiment {
    ...
    public DesmoJExperiment(final DesmoJModel model) {
        ...
        Experiment.setEpsilon(TimeUnit.NANOSECONDS);
        Experiment.setReferenceUnit(TimeUnit.SECONDS); 
        this.experiment = new Experiment(model.getConfiguration().getNameExperimentRun(), new SingleUnitTimeFormatter(TimeUnit.SECONDS, TimeUnit.NANOSECONDS, 9, false));
