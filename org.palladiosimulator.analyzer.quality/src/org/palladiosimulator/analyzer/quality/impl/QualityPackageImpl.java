...
public class QualityPackageImpl extends EPackageImpl implements QualityPackage {
     ...
     * @see org.palladiosimulator.analyzer.quality.QualityPackage#eNS_URI
     * @see #init()
     * @generated
     */
    ...
    public static QualityPackage init() {
        ...
        final QualityPackageImpl theQualityPackage = (QualityPackageImpl) (EPackage.Registry.INSTANCE
                .get(eNS_URI) instanceof QualityPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
                        : new QualityPackageImpl());
    ...
    public void initializePackageContents() {
        ...
        this.initEReference(this.getQualityRepository_QualityStatements(), this.getQualityStatement(),
                this.getQualityStatement_QualityRepository(), "qualityStatements", null, 0, -1, QualityRepository.class,
