 ...
 * <ul>
 * <li>
 * {@link org.palladiosimulator.analyzer.quality.qualityannotation.impl.PCMREResourceInterfaceImpl#getResourceInterface
...
public class PCMREResourceInterfaceImpl extends PCMREImpl implements PCMREResourceInterface {
    ...
    public boolean NextLowerLevelMustConsistOfTypePCMREResourceRole(final DiagnosticChain diagnostics,
        ...
        if (!EOCL_ENV
                .createQuery(NEXT_LOWER_LEVEL_MUST_CONSIST_OF_TYPE_PCMRE_RESOURCE_ROLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
                .check(this)) {
            if (diagnostics != null) {
                diagnostics
