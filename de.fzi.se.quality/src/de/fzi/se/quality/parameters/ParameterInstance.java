 ...
 * </p>
 * <ul>
 * <li>{@link de.fzi.se.quality.parameters.ParameterInstance#getParameterReference
 * <em>Parameter Reference</em>}</li>
 * <li>{@link de.fzi.se.quality.parameters.ParameterInstance#getInputCallInstance
 * <em>Input Call Instance</em>}</li>
 * <li>{@link de.fzi.se.quality.parameters.ParameterInstance#getOutputCallInstance
 * <em>Output Call Instance</em>}</li>
 * <li>{@link de.fzi.se.quality.parameters.ParameterInstance#getComponentInstance
 * <em>Component Instance</em>}</li>
 * <li>{@link de.fzi.se.quality.parameters.ParameterInstance#getParameterValue
