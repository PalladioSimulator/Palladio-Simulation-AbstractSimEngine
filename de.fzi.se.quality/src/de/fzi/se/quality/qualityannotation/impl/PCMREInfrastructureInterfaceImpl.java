 ...
 * </p>
 * <ul>
 * <li>{@link de.fzi.se.quality.qualityannotation.impl.PCMREInfrastructureInterfaceImpl#getInterface
 * <em>Interface</em>}</li>
 * </ul>
 *
 * @generated
...
public class PCMREInfrastructureInterfaceImpl extends PCMREImpl implements PCMREInfrastructureInterface {
    ...
    public boolean NextLowerLevelMustConsistOfTypePCMREInfrastructureRole(final DiagnosticChain diagnostics,
        ...
        if (!EOCL_ENV
                .createQuery(
                        NEXT_LOWER_LEVEL_MUST_CONSIST_OF_TYPE_PCMRE_INFRASTRUCTURE_ROLE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
                .check(this)) {
            if (diagnostics != null) {
                diagnostics
