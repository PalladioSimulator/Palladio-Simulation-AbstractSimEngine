 ...
 * </p>
 * <ul>
 * <li>{@link de.fzi.se.quality.qualityannotation.impl.PCMRECategoryImpl#getCategory
 * <em>Category</em>}</li>
 * </ul>
 *
 * @generated
...
public class PCMRECategoryImpl extends PCMREImpl implements PCMRECategory {
     ...
     */
    @Override
    public boolean NextLowerHierarchyLevelIsPCMREResourceInterfaceForCategoryResource(final DiagnosticChain diagnostics,
    ...
    public boolean EachCategoryExactlyOnceIfSpecified(final DiagnosticChain diagnostics,
        ...
        if (!EOCL_ENV.createQuery(EACH_CATEGORY_EXACTLY_ONCE_IF_SPECIFIED__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
                .check(this)) {
            if (diagnostics != null) {
                diagnostics
                        .add(new BasicDiagnostic(Diagnostic.ERROR, QualityAnnotationValidator.DIAGNOSTIC_SOURCE,
