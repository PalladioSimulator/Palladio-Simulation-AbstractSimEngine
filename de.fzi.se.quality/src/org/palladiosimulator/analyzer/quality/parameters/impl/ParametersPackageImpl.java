...
public class ParametersPackageImpl extends EPackageImpl implements ParametersPackage {
     ...
     * @see org.palladiosimulator.analyzer.quality.parameters.ParametersPackage#eNS_URI
     * @see #init()
     * @generated
     */
    ...
    public static ParametersPackage init() {
        ...
        final QualityAnnotationPackageImpl theQualityAnnotationPackage = (QualityAnnotationPackageImpl) (EPackage.Registry.INSTANCE
                .getEPackage(QualityAnnotationPackage.eNS_URI) instanceof QualityAnnotationPackageImpl
                        ? EPackage.Registry.INSTANCE.getEPackage(QualityAnnotationPackage.eNS_URI)
                        : QualityAnnotationPackage.eINSTANCE);
    ...
    public void initializePackageContents() {
        ...
        this.initEReference(this.getParameterPartition_ParameterReference(), this.getParameterReference(),
                ...
                ParameterPartition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        ...
        this.initEReference(this.getCallInstance_OutputParameterInstances(), this.getParameterInstance(),
                ...
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        this.initEAttribute(this.getCallInstance_NumberOfCalls(), this.ecorePackage.getELong(), "numberOfCalls", "1", 1,
                1, CallInstance.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
