...
public class PCMPackageImpl extends EPackageImpl implements PCMPackage {
     ...
     * @see org.palladiosimulator.analyzer.quality.parameters.pcm.PCMPackage#eNS_URI
     * @see #init()
     * @generated
     */
    ...
    public void initializePackageContents() {
        ...
        this.pcmInfrastructureOperationReferenceEClass.getESuperTypes()
                .add(theParametersPackage.getOperationReference());
        ...
        this.pcmRequiredBusinessOperationReturnParameterReferenceEClass.getESuperTypes()
                .add(this.getPCMParameterReference());
