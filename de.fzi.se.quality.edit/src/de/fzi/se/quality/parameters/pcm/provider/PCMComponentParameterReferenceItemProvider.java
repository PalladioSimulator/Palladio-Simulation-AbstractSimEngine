...
public class PCMComponentParameterReferenceItemProvider extends PCMParameterReferenceItemProvider {
    ...
    protected void addImplementationComponentTypePropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PCMComponentParameterReference_implementationComponentType_feature"),
                this.getString("_UI_PropertyDescriptor_description",
                        "_UI_PCMComponentParameterReference_implementationComponentType_feature",
                        "_UI_PCMComponentParameterReference_type"),
                PCMPackage.Literals.PCM_COMPONENT_PARAMETER_REFERENCE__IMPLEMENTATION_COMPONENT_TYPE, true, false, true,
                null, null, null));
    }
    ...
    protected void addVariableUsagePropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_PCMComponentParameterReference_variableUsage_feature"),
                this.getString("_UI_PropertyDescriptor_description",
    ...
    public Object getImage(final Object object) {
        return this.overlayImage(object,
                this.getResourceLocator().getImage("full/obj16/PCMComponentParameterReference"));
    }
    ...
    public String getText(final Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_PCMComponentParameterReference_type")
                : this.getString("_UI_PCMComponentParameterReference_type") + " " + label;
    }
