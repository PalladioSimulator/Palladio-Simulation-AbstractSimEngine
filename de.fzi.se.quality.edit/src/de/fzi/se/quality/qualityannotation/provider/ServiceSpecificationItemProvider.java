...
public class ServiceSpecificationItemProvider extends IdentifierItemProvider {
    ...
    protected void addChecksumPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_ServiceSpecification_checksum_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_ServiceSpecification_checksum_feature",
    ...
    protected void addChecksumAlgPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_ServiceSpecification_checksumAlg_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_ServiceSpecification_checksumAlg_feature",
                        "_UI_ServiceSpecification_type"),
    ...
    public String getText(final Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_ServiceSpecification_type")
                : this.getString("_UI_ServiceSpecification_type") + " " + label;
    }
