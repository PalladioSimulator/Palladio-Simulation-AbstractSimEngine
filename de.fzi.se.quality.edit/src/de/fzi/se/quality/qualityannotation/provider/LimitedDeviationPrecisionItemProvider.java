...
public class LimitedDeviationPrecisionItemProvider extends PrecisionItemProvider {
    ...
    protected void addAbsolutePropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_LimitedDeviationPrecision_absolute_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_LimitedDeviationPrecision_absolute_feature",
    ...
    protected void addRelativePropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_LimitedDeviationPrecision_relative_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_LimitedDeviationPrecision_relative_feature",
                        "_UI_LimitedDeviationPrecision_type"),
    ...
    public String getText(final Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_LimitedDeviationPrecision_type")
                : this.getString("_UI_LimitedDeviationPrecision_type") + " " + label;
    }
