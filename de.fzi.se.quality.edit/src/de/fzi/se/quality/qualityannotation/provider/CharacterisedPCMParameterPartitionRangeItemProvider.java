...
public class CharacterisedPCMParameterPartitionRangeItemProvider
    ...
    public String getText(final Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_CharacterisedPCMParameterPartitionRange_type")
                : this.getString("_UI_CharacterisedPCMParameterPartitionRange_type") + " " + label;
    }
