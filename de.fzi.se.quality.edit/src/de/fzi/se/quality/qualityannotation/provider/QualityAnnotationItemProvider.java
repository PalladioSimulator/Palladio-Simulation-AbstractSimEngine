...
public class QualityAnnotationItemProvider extends QualityStatementItemProvider {
    ...
    protected void addIsValidPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_QualityAnnotation_isValid_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_QualityAnnotation_isValid_feature",
                        "_UI_QualityAnnotation_type"),
                QualityAnnotationPackage.Literals.QUALITY_ANNOTATION__IS_VALID, true, false, false,
    ...
    public String getText(final Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_QualityAnnotation_type")
                : this.getString("_UI_QualityAnnotation_type") + " " + label;
    }
    ...
    protected void collectNewChildDescriptors(final Collection<Object> newChildDescriptors, final Object object) {
        ...
        newChildDescriptors.add(
                this.createChildParameter(QualityAnnotationPackage.Literals.QUALITY_ANNOTATION__PROBABILISTIC_ELEMENTS,
