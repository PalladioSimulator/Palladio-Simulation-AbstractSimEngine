 ...
 * {@link org.palladiosimulator.analyzer.quality.qualityannotation.PCMREResource} object. <!--
...
public class PCMREResourceItemProvider extends PCMREItemProvider {
    ...
    protected void addProcessingResourceTypePropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PCMREResource_processingResourceType_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_PCMREResource_processingResourceType_feature",
    ...
    public String getText(final Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_PCMREResource_type")
                : this.getString("_UI_PCMREResource_type") + " " + label;
    }
