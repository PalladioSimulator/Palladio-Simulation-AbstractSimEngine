...
public abstract class SimulatedProcess implements ISimProcess {
    ...
    public void startProcess(final ISimProcessStrategy processStrategy) {
        final SuspendableRunnable myRunnable = new ProcessRunnable(this);
        processStrategy.startProcess(myRunnable);
    }

    public void actions() throws SuspendExecution {
        // set state to running and suspended, i.e., return to constructor
        this.myProcessState = ProcessState.RUNNING;
        LOGGER.info("Process set to running " + getAbstractProcess().getId());
        suspend();
    ...
    public void suspend() throws SuspendExecution {
...
//        }
        ...
        LOGGER.info("Process set to suspended " + getAbstractProcess().getId());
    ...
    protected void resume() throws SuspendExecution {
        ...
        LOGGER.info("Resuming thread [" + this.getAbstractProcess().getId() + "]");
